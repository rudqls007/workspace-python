...
# 딕셔너리 자료형 (순서 x, 중복 x, 수정 o, 삭제 o)
'''
    1. 사전(dictionary) 자료형
        1) 데이터를 키(key)와 값(value) 쌍의 형태로 저장할 때 사용할 수 있다.
...
# 선언
a = {'name' : 'ezen', 'phone' : '0102345678', 'birth' : '990124'}
b = {0 : 'Hello Ezen'}
c = { ' arr ' : [1, 2, 3, 4]}
...
# 출력
#print('a : ', a['name1'])        # 존재 x => 에러 발생
print('a : ', a.get('phone1'))    # 존재 x => None 처리(get 사용했을 때)
print('b : ', b[0])
print('b : ', b.get(0))
print('c : ', c[' arr '])
print('c : ', c[' arr '][3])
...
# 모든 키(key)를 하나씩 확인할 때는 keys()메서드를 사용한다
...
'''
    ...
    - 특정한 데이터가 등장한 적이 있는지 체크할 때 효과적으로 사용된다.
