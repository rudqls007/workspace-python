...
# 위의 학생 5명의 키를 작은 순부터 큰 순서로 정렬하여 출력하시오.
heights.sort()
print(heights)

# 위에서 만든 리스트의 데이터 타입을 확인해보시오.
print('type(heights) : ', type(heights), heights)

# 위의 리스트의 데이터 길이를 출력하시오.
print('len(heights) : ',len(heights), heights)
...
'''
    ...
    이 친구의 키는 200cm 입니다.
    이를 반영하여 코드를 구현하시오. heights의 길이도 구하시오. 
'''
heights.append(200)
print('len(heights) : ',len(heights), heights)
...
'''
    ...
    데이터 타입 중 Dictionary로 위처럼 이름(name_key)과 키(height_value)를 같이 붙여주려고 합니다.
...
print('class_A : ', type(class_A), class_A)
print(class_A["반태희"])
...
# ezen의 index2부터 끝까지 잘라내기를 하시오. = index2부터 끝까지 출력하시오.
print(ezen[2:])
print(ezen[-1])

# ezen 원소 중 'a'를 출력해보시오.
print(ezen[1][0])
